...
def drawMiddle():
    ...
    for x in range(0, line_count, 3):
        pygame.draw.line(DISPLAYSURF, WHITE, ((WINDOWWIDTH // 2), x * WINDOWHEIGHT/line_count), ((WINDOWWIDTH // 2), (x+1) * WINDOWHEIGHT/line_count), LINETHICKNESS // 4)
